...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/src/EventListener/ContadorListener.php';
            ...
            include_once \dirname(__DIR__, 4).'/vendor/api-platform/core/src/Bridge/Doctrine/MongoDbOdm/Metadata/Property/DoctrineMongoDbOdmPropertyMetadataFactory.php';
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.request', [0 => function () {
            return ($this->privates['App\\EventListener\\ContadorListener'] ?? ($this->privates['App\\EventListener\\ContadorListener'] = new \App\EventListener\ContadorListener()));
        }, 1 => 'onKernelRequest'], 0);
    ...
    protected function getDebug_ApiPlatform_CollectionDataProviderService()
    {
        return $this->privates['debug.api_platform.collection_data_provider'] = new \ApiPlatform\Core\Bridge\Symfony\Bundle\DataProvider\TraceableChainCollectionDataProvider(new \ApiPlatform\Core\DataProvider\ChainCollectionDataProvider(new RewindableGenerator(function () {
            ...
            yield 1 => ($this->privates['api_platform.doctrine_mongodb.odm.default.collection_data_provider'] ?? $this->load('getApiPlatform_DoctrineMongodb_Odm_Default_CollectionDataProviderService'));
        }, 2)));
    }
    ...
    protected function getDebug_ApiPlatform_DataPersisterService()
    {
        return $this->privates['debug.api_platform.data_persister'] = new \ApiPlatform\Core\Bridge\Symfony\Bundle\DataPersister\TraceableChainDataPersister(new \ApiPlatform\Core\DataPersister\ChainDataPersister(new RewindableGenerator(function () {
            ...
            yield 1 => ($this->privates['api_platform.doctrine_mongodb.odm.data_persister'] ?? $this->load('getApiPlatform_DoctrineMongodb_Odm_DataPersisterService'));
        }, 2)));
    }
    ...
    protected function getDebug_ApiPlatform_ItemDataProviderService()
    {
        return $this->privates['debug.api_platform.item_data_provider'] = new \ApiPlatform\Core\Bridge\Symfony\Bundle\DataProvider\TraceableChainItemDataProvider(new \ApiPlatform\Core\DataProvider\ChainItemDataProvider(new RewindableGenerator(function () {
            ...
            yield 1 => ($this->privates['api_platform.doctrine_mongodb.odm.default.item_data_provider'] ?? $this->load('getApiPlatform_DoctrineMongodb_Odm_Default_ItemDataProviderService'));
        }, 2)));
    }
    ...
    protected function getDebug_ApiPlatform_SubresourceDataProviderService()
    {
        return $this->privates['debug.api_platform.subresource_data_provider'] = new \ApiPlatform\Core\Bridge\Symfony\Bundle\DataProvider\TraceableChainSubresourceDataProvider(new \ApiPlatform\Core\DataProvider\ChainSubresourceDataProvider(new RewindableGenerator(function () {
            ...
            yield 1 => ($this->privates['api_platform.doctrine_mongodb.odm.default.subresource_data_provider'] ?? $this->load('getApiPlatform_DoctrineMongodb_Odm_Default_SubresourceDataProviderService'));
        }, 2)));
    }
    ...
    protected function getPropertyInfoService()
    {
        return $this->privates['property_info'] = new \Symfony\Component\PropertyInfo\PropertyInfoExtractor(new RewindableGenerator(function () {
            ...
            yield 3 => ($this->privates['api_platform.doctrine_mongodb.odm.default_document_manager.property_info_extractor'] ?? $this->load('getApiPlatform_DoctrineMongodb_Odm_DefaultDocumentManager_PropertyInfoExtractorService'));
            ...
            yield 1 => ($this->privates['api_platform.doctrine_mongodb.odm.default_document_manager.property_info_extractor'] ?? $this->load('getApiPlatform_DoctrineMongodb_Odm_DefaultDocumentManager_PropertyInfoExtractorService'));
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Component\Validator\ContainerConstraintValidatorFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Validator\\CpfCnpjValidator' => ['privates', 'App\\Validator\\CpfCnpjValidator', 'getCpfCnpjValidatorService', true],
            ...
            'App\\Validator\\CpfCnpjValidator' => '?',
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'api_platform.resource_class_directories' => [
                ...
                1 => (\dirname(__DIR__, 4).'/src/Document'),
            ],
